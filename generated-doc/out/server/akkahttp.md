...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.28"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.28" exclude("com.typesafe.akka", "akka-stream_2.12")
```
