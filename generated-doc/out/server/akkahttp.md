...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.29"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.29" exclude("com.typesafe.akka", "akka-stream_2.12")
```
