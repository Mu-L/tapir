...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-akka-http-server" % "1.13.26" exclude("com.typesafe.akka", "akka-stream_2.12")
```
