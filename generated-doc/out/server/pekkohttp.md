...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.26" exclude("org.apache.pekko", "pekko-stream_2.12")
```
