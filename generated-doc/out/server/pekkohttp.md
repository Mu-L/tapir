...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.28"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.28" exclude("org.apache.pekko", "pekko-stream_2.12")
```
