...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.29"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-pekko-http-server" % "1.13.29" exclude("org.apache.pekko", "pekko-stream_2.12")
```
