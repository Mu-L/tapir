...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-circe" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-upickle" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play" % "1.13.26"
```

For **Play 2.9** use:

```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-play29" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-spray" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-tethys" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-jsoniter-scala" % "1.13.26"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-json4s" % "1.13.26"
```

And one of the implementations:

```scala
"org.json4s" %% "json4s-native" % "4.1.1"
// Or
"org.json4s" %% "json4s-jackson" % "4.1.1"
```
...
```scala
"com.softwaremill.sttp.tapir" %% "tapir-json-zio" % "1.13.26"
```
